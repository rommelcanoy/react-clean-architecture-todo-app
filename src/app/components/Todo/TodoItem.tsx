...
import { deleteTodoAsync, toggleCompleteAsync, updateTodoAsync } from '../../redux/todo/todoSlice';
  ...
  return <li key={id} className={`hover:bg-gray-100 p-3 ${completed ? "bg-gray-50" : ""}`}>
    <div className="flex gap-3 justify-between items-center">
      ...
      <div className='flex-none flex gap-2'>
        ...
        {edit ? (<button onClick={handleEdit} disabled={loading} className="inline-flex items-center justify-center p-2 text-white bg-sky-400 hover:bg-sky-500 rounded-md shadow-lg">
        ...
        ) : (<button onClick={() => setEdit(true)} disabled={loading} className="inline-flex items-center justify-center p-2 text-white bg-sky-400 hover:bg-sky-500 rounded-md shadow-lg">
        ...
        <button onClick={handleDelete} disabled={loading} className="inline-flex items-center justify-center p-2 text-white bg-red-400 hover:bg-red-500 rounded-md shadow-lg">
