...
const TodoInput = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex gap-2 text-sm">
      ...
      <button type="submit" disabled={loading} className={`${loading ? 'cursor-progress' : 'hover:bg-sky-500'} inline-flex items-center justify-center py-2 px-2 text-white bg-sky-400 rounded-md shadow-lg`}>
        {/* Add */}
